...
Navigate to: `/experiments/font-analyzer`
...
```
/app/(app)/experiments/font-analyzer/
...
└── components/
    ...
    ├── ImageDetailsPanel.tsx             # Basic image display (legacy)
...
1. Navigate to `/experiments/font-analyzer`
